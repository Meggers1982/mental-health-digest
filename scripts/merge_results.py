...
Reads from /tmp/artifacts/mh-results-*/results.json
...
def send_summary_email(new_count: int, total: int, timestamp: str):
    ...
    subject  = f"Mental Health & Psychiatry Research Digest — {run_date} | {new_count} {'Study' if new_count == 1 else 'Studies'}"
    html = f"""<!DOCTYPE html>
<html>
